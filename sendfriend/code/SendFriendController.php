...
//			new TextareaField('Remarks', _t('SendFriend.FORM_LABEL_REMARKS', "Remarks")),
            new TextareaField('Remarks', _t('SendFriend.FORM_LABEL_REMARKS', "Remarks"), 'Have a look at this product, it might be something you\'re interested in.'),
...
//$subject = _t('SendFriend.SUBJECT','Interesting article on ') . SiteConfig::current_site_config()->getTitle(); //SiteConfig::current_site_config()->Title
		// CACTUS
		$subject = 'Interesting product on NZ Commercials and Industrial';
