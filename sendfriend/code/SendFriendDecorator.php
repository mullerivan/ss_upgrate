...
class SendFriendDecorator extends Extension {
	...
	function SendFriendLink() {
		...
		if (self::$JSMode == 'Jquery') {
			...
			return '<a href="' . Director::absoluteBaseURL() . 'sendfriend?sendurl=' . Director::absoluteBaseURL() . $this->owner->URLSegment . '" id="tellafriend">'.
            "<img src='{$BaseHref}themes/mainline/images/group.png' border='0' width='16' height='16' alt='Send to friend' title='Send to friend'/>"
            . _t('SendFriend.SENDFRIENDLINK', "Send to a friend") .
            '</a>';
		} else {
			//default mode
			...
			return '<a href="' . Director::absoluteBaseURL() . 'sendfriend?sendurl=' . Director::absoluteBaseURL() . $this->owner->URLSegment . '" rel="gb_page_center[' . SENDFRIEND_POPUP_WIDTH . ', ' . SENDFRIEND_POPUP_HEIGHT . ']">'.
            "<img src='{$BaseHref}themes/mainline/images/group.png' border='0' width='16' height='16' alt='Send to friend' title='Send to friend'/>"
            . _t('SendFriend.SENDFRIENDLINK', "Send to a friend") .
            '</a>';
		}
